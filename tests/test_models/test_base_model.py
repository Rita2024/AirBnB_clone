#!/usr/bin/python3
"""Importing modules for testing base model"""
import unittest
import pep8
import datetime
import json
...
class TestBaseModel(unittest.TestCase):
    ...
    def test_pep8_conformance_base_model(self):
        """Test base_model is inline with PEP8."""
    ...
    def test_pep8_conformance_test_base_model(self):
        """Test test_base_model inline with PEP8."""
        pep8style = pep8.StyleGuide(quiet=True)
    ...
    def test_first_task(self):
        """Test the class creation plus to_dict"""
        my_model = BaseModel()
    ...
    def test_constructor_kwargs(self):
        """constructor with kwargs attributes test"""
        obj = BaseModel()
        obj.name = "Holberton"
        obj.my_number = 89
